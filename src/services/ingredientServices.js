...
export async function addFridgeItem(username, item) {
  const response = await api.post(
    "/ingredients/" + username + "/fridge/new",
    item
  );
  return response.data;
}
...
export async function deleteFridgeItem(username, item) {
  const response = await api.delete(
    "/ingredients/" + username + "/fridge/delete",
    { data: item }
  );
  return response;
}
...
export async function deleteAllFridge(username) {
  const response = await api.delete(
    "/ingredients/" + username + "/fridge/clear-all"
  );
  return response.data;
}
...
export async function addPantryItem(username, item) {
  const response = await api.post(
    "/ingredients/" + username + "/pantry/new",
    item
  );
  return response.data;
}
...
export async function deletePantryItem(username, item) {
  const response = await api.delete(
    "/ingredients/" + username + "/pantry/delete",
    { data: item }
  );
  return response.data;
}
...
export async function deleteAllPantry(username, item) {
  const response = await api.delete(
    "/ingredients/" + username + "/pantry/clear-all",
    item
  );
  return response.data;
}
...
export function setFridge(items) {
  items
    ? localStorage.setItem("fridge", items)
...
export function setPantry(items) {
  items
    ? localStorage.setItem("pantry", items)
