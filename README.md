...
| Cypress | Loads the preferences page |  Pass |
| Cypress | Shows preferences from state|  Pass |
| Cypress | Previous selections are loaded from state |  Pass |
...
| Cypress | Log in | Logs in and loads homepage with incorrect username in nav |  Fail |
 ...
 | Cypress |Register | Incorrect errors for incorrect input |  Pass |
